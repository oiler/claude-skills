...
allowed-tools: Bash(uv run pytest *) Bash(uv run ruff *) Bash(uv run mypy *) Bash(uv run pyright *) Bash(python -m pytest *) Bash(pytest *) Bash(ruff *) Bash(mypy *) Bash(pyright *)
---
